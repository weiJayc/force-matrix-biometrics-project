...
from AI.authentication.legacy.feature_extractor import extract_feature_combination
from AI.authentication.legacy.evaluate_threshold import find_best_threshold
from AI.authentication.legacy.knn_auth import KNNAuthenticator
